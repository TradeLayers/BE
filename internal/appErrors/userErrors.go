...
const (
	...
	ErrAlertNotFound
	ErrDonationNotConfigured
	ErrInvalidDonationAmount
...
var clientErrors map[DomainError]ErrorResponse = map[DomainError]ErrorResponse{
	...
	ErrDonationNotConfigured:      {503, "Donation checkout is not configured yet."},
	ErrInvalidDonationAmount:      {400, "Donation amount must be between 1 and 500."},
	ErrPaymentProviderUnavailable: {502, "Payment provider is temporarily unavailable. Please try again later."},
}
