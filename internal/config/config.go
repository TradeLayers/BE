...
type Config struct {
	...
	StripeDonationCurrency    string
	StripeDonationProductName string
}
...
func Load() *Config {
	...
	return &Config{
		...
		StripeDonationCurrency:    getEnv("STRIPE_DONATION_CURRENCY", "eur"),
		StripeDonationProductName: getEnv("STRIPE_DONATION_PRODUCT_NAME", "TradeLayers donation"),
	}
}
